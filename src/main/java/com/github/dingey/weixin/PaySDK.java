...
public interface PaySDK extends CryptoSDK {
     ...
     * @throws Exception 异常
     */
    Map<String, String> unifiedorder(Unifiedorder order) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, String> orderquery(Orderquery order) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, String> closeorder(Orderquery order) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, String> refund(Refund refund, InputStream secStream) throws Exception;
     ...
     * @throws Exception 异常
     */
    boolean verifyNotify(Map<String, String> param, String key) throws Exception;
}
