...
public interface MpSDK extends PaySDK {
    /**
     ...
     * @throws Exception 异常
     */
    Map<String, String> token(String appid, String secret) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, Object> getAllPrivateTemplate(String accessToken) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, Object> sendCustomMessage(String accessToken, String openid, CustomMessage message) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, Object> sendTemplateMessage(String accessToken, TemplateMessage message) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, Object> userInfo(String accessToken, String openid) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, Object> userInfoBatchget(String accessToken, String... openid) throws Exception;
     ...
     * @throws Exception 异常
     */
    Map<String, Object> materialBatchget(String accessToken, String type, int offset, int count) throws Exception;
}
